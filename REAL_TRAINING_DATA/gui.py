...
class DataSuite(QMainWindow):
    def __init__(self):
        ...
        self.first_col_spacer.setFixedHeight(105)
        ...
        for i in range(len(self.selections)):
            ...
            label.setStyleSheet("margin-top: 5px; padding: 0px; margin-right: 5px;")
        ...
        self.second_col_spacer.setFixedHeight(3)
        ...
        self.third_col_spacer.setFixedHeight(190)
    ...
    def generate_results(self):
        ...
        calculateResults(file_path, num_rows, num_cols, num_droplets, output_filename, selections, marker_present, output_folder)
